    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuerpo', models.CharField(max_length=20, verbose_name='core.Cuerpo')),
                ('imagen', models.ImageField(upload_to='static/img', null=True, blank=True, verbose_name='core.Imagen')),
            ],
        ),
    ]
